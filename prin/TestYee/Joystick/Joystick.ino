...
void loop() {
  ...
  else if (controller_data.R2 >= 1) {
    current_L = controller_data.R2;
    current_R = controller_data.R2;
  }
  else if (controller_data.L2 >= 1) {
    current_L = -controller_data.L2;
    current_R = -controller_data.L2;
  }
  else {
    current_L = 0;
    current_R = 0;
